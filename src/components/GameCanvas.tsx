...
export function GameCanvas({ reducedMotion, casualMode, audioSettings, active = true, course = '1-1' }: { reducedMotion: boolean; casualMode: boolean; audioSettings: AudioSettings; active?: boolean; course?: '1-1' | 'practice' }) {
