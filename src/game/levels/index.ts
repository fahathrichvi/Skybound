...
import { BOSS_1 } from './world1/boss';

/** Register additional definitions here; scenes and the world builder remain unchanged. */
export const LEVELS: Readonly<Record<string, LevelConfig>> = { practice: PRACTICE_LEVEL, '1-1': LEVEL_1, '1-2': LEVEL_2, '1-3': LEVEL_3, '1-B': BOSS_1 };
